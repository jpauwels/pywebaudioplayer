...
class Wavesurfer:
    def __init__:
        global wavesurfer_cnt
        wavesurfer_cnt += 1
        
    def __call__(self, audio_path=None, controls={}, display={}, behaviour={}, samples=None):
        # Set defaults
...
class WaveformPlaylist:
    def __init__():
        global waveform_playlist_cnt
        waveform_playlist_cnt += 1
        
    def __call__(self, tracks, controls={}, display={}, behaviour={}):
        # Set defaults
        if 'text_controls' not in controls:
        ...
        <link rel="stylesheet" href="static/waveform-playlist/dist/waveform-playlist/css/main.css">
        ...
        <script type="text/javascript" src="static/waveform-playlist/dist/waveform-playlist/js/waveform-playlist.var.js"></script>'''.format(
        unique_id
        )
        ...
        <script type="text/javascript" src="static/waveform-playlist/dist/waveform-playlist/js/emitter.js"></script>
        '''
        return html_code
...
class Trackswitch:
    ...
    def __call__(self, tracks, text='', seekable_image=None, seek_margin=None, mute=True, solo=True, globalsolo=True, repeat=False, radiosolo=False, onlyradiosolo=False, spacebar=False, tabview=False):
        unique_id = _id()
        ...
        <link rel="stylesheet" href="static/trackswitch.js/css/trackswitch.css" />
        ...
        <script src="static/trackswitch.js/js/trackswitch.js"></script>
        <script type="text/javascript">
